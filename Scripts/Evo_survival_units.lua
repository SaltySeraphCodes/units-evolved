...
unit_woc = sm.uuid.new( "264a563a-e304-430f-a462-9963c77624e9" ) -- orignal woc uuid
...
unit_cursed_farmbot = sm.uuid.new("1d0f3ad6-a775-47b4-9a74-0100f55039a1") --  --"1d0f3ad6-a775-47b4-9a74-0100f55039a1" <-(original cfb)
unit_player_woc = sm.uuid.new( "df74a19a-02d3-4ece-89b1-d6d9f2c48840" ) -- player woc
unit_player_worm = sm.uuid.new('9a414538-dfc8-417f-a27d-a1b0dbe8f1e0')
