...
CursedFarmbotCharacter = class( nil )
...
function CursedFarmbotCharacter.client_onCreate( self )
	print(
		"CHAR custom cursed farmbot create"
	)
	self.cl = {}
	self.cl.animations = {}
	...
	print( "-- CursedFarmbotCharacter created --" )
	self:client_onRefresh()
end

function CursedFarmbotCharacter.client_onDestroy( self )
	print( "-- CursedFarmbotCharacter destroyed --" )
end

function CursedFarmbotCharacter.client_onRefresh( self )
	print( "-- CursedCursedFarmbotCharacter refreshed --" )
	self.cl.headAngle = 0.0
	self.cl.currentAnimation = ""
end

function CursedFarmbotCharacter.client_onGraphicsLoaded( self )
...
function CursedFarmbotCharacter.client_onGraphicsUnloaded( self )
	self.graphicsLoaded = false
end

function CursedFarmbotCharacter.cl_initGraphics( self )
...
function CursedFarmbotCharacter.cl_initAnimationSwitch( self )
...
function CursedFarmbotCharacter.client_onUpdate( self, deltaTime )
...
function CursedFarmbotCharacter.client_onEvent( self, event )
	self:client_handleEvent( event )
end

function CursedFarmbotCharacter.client_handleEvent( self, event )
...
function CursedFarmbotCharacter.sv_e_updateTarget( self, params )
	self.network:sendToClients( "cl_n_updateTarget", params )
end

function CursedFarmbotCharacter.cl_n_updateTarget( self, params )
	self.cl.target = params.target
end

function CursedFarmbotCharacter.sv_e_characterEffect( self, params )
	self.network:sendToClients( "cl_n_characterEffect", params )
end

function CursedFarmbotCharacter.cl_n_characterEffect( self, params )
	sm.effect.playHostedEffect( params.effectName, self.character, params.jointName, params.effectParams )
end

function CursedFarmbotCharacter.sv_e_unitDebugText( self, text )
	-- No sync cheat
