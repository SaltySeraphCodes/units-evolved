...
function WocCharacter.client_onClientDataUpdate( self, data )
...
function WocCharacter.client_onInit(self) -- initialize
	--self.username
	--self.userid
	--self.chatMessage
...
function WocCharacter.testRecieveEvent(self,params)
	print("woc recieved test event",params)
end

function WocCharacter.sv_recieveEvent(self,params)
...
function WocCharacter.cl_recieveEvent(self,params)
